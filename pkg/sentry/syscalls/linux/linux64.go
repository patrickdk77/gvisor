...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		9:   syscalls.SupportedPoint("mmap", Mmap, PointMmap),
		...
		424: syscalls.Supported("pidfd_send_signal", PIDFDSendSignal),
		...
		437: syscalls.PartiallySupported("openat2", Openat2, "RESOLVE_CACHED always fails with EAGAIN, since resolution may require a gofer RPC.", nil),
